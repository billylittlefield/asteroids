(function () {
  ...
  Ship.prototype.power = function(pulse) {
    ...
    this.vel[0] += (this.direction_vector()[0] * pulse);
    this.vel[1] += (this.direction_vector()[1] * pulse);
    if (this.speed_magnitude() > 8) {
      this.vel[0] = this.vel[0] * 0.8;
      this.vel[1] = this.vel[1] * 0.8;
    }
  };
  ...
  Ship.prototype.fireBullet = function() {
    var newBullet = new Asteroids.Bullet({ pos: this.pos.slice(), game: this.game,
        vel: [this.direction_vector()[0] * 10, this.direction_vector()[1] * 10] });
